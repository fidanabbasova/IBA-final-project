...
import './createLostPost.scss'
class CreateLostPost extends Component {
    constructor(props) {
        super(props);
        this.state = {
            cities: [],
    ...
    render() {
        ...
        return(
            <div className="modal create-lost-modal fade" id="createLostPost" tabIndex="-1" role="dialog"
             aria-labelledby="createLostPostTitle" aria-hidden="true">
                <div className="modal-dialog modal-dialog-centered col-md-12" role="document">
                    <div className="modal-content">
                        <div className="modal-header">
                            <div className="modal-title col-md-10 offset-md-1 text-center"><i className="fas fa-paw"></i> Create post for lost pet</div>
                        ...
                        <div className="modal-footer col-md-10 offset-md-1">
                            ...
                            <button type="button" className="modal-button lost-btn"><i className="fas fa-plus"></i> Create</button>
                        </div>
                    </div>
                </div>
            </div>
